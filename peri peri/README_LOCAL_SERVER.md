...
3. Open your browser and go to: `http://localhost:8000/index.html` (Dashboard)
...
Then open: `http://localhost:8000/index.html` (Dashboard). Orders now live at `http://localhost:8000/orders.html`.
