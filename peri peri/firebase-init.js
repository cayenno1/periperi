...
(async function() {
    try {
        ...
        const { getFirestore, doc, getDoc, collection, getDocs, updateDoc, setDoc, serverTimestamp, increment, onSnapshot, query, orderBy, deleteField } = await import("https://www.gstatic.com/firebasejs/12.6.0/firebase-firestore.js");
