...
(async function() {
    try {
        ...
        const { getFirestore, doc, getDoc, collection, getDocs, updateDoc, setDoc, serverTimestamp, increment, onSnapshot, query, orderBy } = await import("https://www.gstatic.com/firebasejs/12.6.0/firebase-firestore.js");
        const { getStorage, ref, getDownloadURL, listAll } = await import("https://www.gstatic.com/firebasejs/12.6.0/firebase-storage.js");
